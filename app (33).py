        ...
        if st.button("🔄 Continuous Retraining"):
            if st.session_state.model is not None:
                with st.spinner("Retraining model..."):
                    ...
                    st.info("In real production, this happens automatically with new streaming data.")

# ====================== TAB 3: SINGLE PREDICTION (Same as your current app) ======================
with tab3:
    if st.session_state.model is None:
        ...
        if st.button("🔍 Check for Fraud", type="primary"):
            # Using only available columns to avoid error
        ...
        if st.button("Start Real-time Streaming"):
            ...
            for i in range(15):
                with placeholder.container():
                    ...
                    input_data.iloc[0, -1] = amount   # Set Amount
...
In production, we would use **Apache Kafka** for real-time streaming, continuous retraining, and advanced monitoring.
""")
