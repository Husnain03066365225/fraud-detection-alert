...
# TAB 3: SINGLE PREDICTION (V1-V5 only - FIXED)
with tab3:
    if st.session_state.model is None:
        ...
        if st.button("🔍 Predict + Explain with SHAP", type="primary"):
            # FIXED: Create full row with all columns
            input_dict = {col: 0.0 for col in st.session_state.columns}
            input_dict['V1'] = v1
            input_dict['V2'] = v2
            input_dict['V3'] = v3
            input_dict['V4'] = v4
...
st.info("**Future Enhancements:** Real Kafka streaming, continuous retraining, advanced SHAP explainability, location tracking, etc.")
