...
# ====================== TAB 3: SINGLE PREDICTION (Same Layout) ======================
with tab3:
    if st.session_state.model is None:
        ...
        if st.button("🔍 Predict + Explain with SHAP", type="primary"):
            ...
            with st.spinner("Calculating SHAP values..."):
                ...
                st.info("**Interpretation:** Longer bars = stronger influence on the prediction. Positive = pushed toward fraud.")
...
st.info("**Future Enhancements:** Real Apache Kafka streaming, continuous retraining, advanced SHAP explanations, and mobile integration.")
